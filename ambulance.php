...
<section class="doctors" id="contact">
    ...
    <h1 class="heading">To <span>contact</span> us </h1>
    <section class="home">
    <div class="content">
            <h3>Don't hesitate</h3>
            <p>Call Midnight Medical Ambulances for reliable care you can trust. Our team is on call 24/7 and ready to provide the best emergency response services. Don't wait - get the care you need now by contacting Midnight Medical Ambulances.</p>
        </div>
    </section>
    <div class="box">
            <a href="" class="btn"><span class="fas fa-phone"></span><br> Save it for emergency <br>call us now:+91 7797134855 / +91 8017023941</a>
    </div>
