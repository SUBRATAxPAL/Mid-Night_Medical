...
<head>
    ...
    <title>emergency oxygen service</title>
...
<section class="doctors" id="contact">
    ...
    <div class="content">
            ...
            <p>Our team is on call 24/7 and ready to provide the best emergency response services.</p>
        </div>
    </section>
    <div class="box">
